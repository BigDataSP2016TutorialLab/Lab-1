...
public class CommonFriendsMR {
    ...
    public static class FriendsReducer
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            // Calculate the intersection of these lists and write result in the form (UserAUserB, CommonFriendsMR).
    ...
    public static void main(String args[]) throws Exception {
        ...
        job.setJarByClass(CommonFriendsMR.class);
